...
#
# Script Name:: list-workload-templates
# Script Type: API script, using RubySDK and Bracket FOG plugin
# Script Description: List all Workload Templates
#
# Script dependancies:
#   
#
...
print "List of Workload Templates:\n"
wktemps = compute.workload_templates
wktemps.each do |tempname|
	puts "#{tempname.name}: #{tempname.id}"
end